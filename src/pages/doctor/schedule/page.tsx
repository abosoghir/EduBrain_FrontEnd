...
export default function DoctorSchedule() {
  ...
  useEffect(() => {
    api.get<ApiResponse<DoctorScheduleSlot[]>>('/api/doctor/schedule')
      .then((res) => {
          ...
          <div className="space-y-3">
            {scheduleByDay[selectedDay].map((slot) => (
              <div
                ...
                className="flex items-center gap-4 p-4 rounded-lg bg-gray-50 hover:bg-violet-50/30 transition-colors"
              >
