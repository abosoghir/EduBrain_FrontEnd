...
export default function DoctorCourses() {
  ...
  useEffect(() => {
    api.get<ApiResponse<DoctorCourse[]>>('/api/doctor/courses')
      .then((res) => {
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-50 rounded-lg p-2.5">
                <p className="text-[10px] text-slate-400 mb-0.5">Students</p>
                <p className="text-sm font-bold text-slate-700">{course.totalStudents}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-2.5">
                <p className="text-[10px] text-slate-400 mb-0.5">Schedule</p>
                <p className="text-xs font-medium text-slate-700 truncate">{course.scheduleSummary}</p>
              </div>
            </div>
